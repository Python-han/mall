<template>
	<el-card shadow="hover" header="版本信息">
		<div style="height: 210px;text-align: center;">
			...
			<h2 style="margin-top: 15px;">baykeshop商城系统</h2>
			<p style="margin-top: 5px;">最新版本 1.0.0</p>
		</div>
...
<script>
	export default {
		...
		methods: {
			...
			golog(){
				window.open("https://gitee.com/bayke/bayke-shop/releases")
			},
			gogit(){
				window.open("https://gitee.com/bayke/bayke-shop")
			}
		}
	}
</script>
