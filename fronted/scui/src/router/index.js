...
router.beforeEach(async (to, from, next) => {
	...
	// const res = await api.badmin.system.readsystem.get('site_title')
	const res = JSON.parse(useLocalStorage("SYSTEM").value)
	document.title = to.meta.title ? `${to.meta.title} - ${res.site_title}` : `${res.site_title}`
