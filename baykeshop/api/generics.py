...
class BaykeProductSPUListAPIView(ListAPIView):
    ...
    from .serializers import BaykeProductSPUSerializer
    from .filters import BaykeProductSPUFilter
...
from .mixins import BaykeProductSPURetrieveMixin
...
class BaykeProductCategoryListAPIView(ListAPIView):
    """ 商品分类接口 """
    
    from baykeshop.models import BaykeProductCategory
    from .serializers import BaykeProductCategorySerializer
    serializer_class = BaykeProductCategorySerializer
    queryset = BaykeProductCategory.objects.filter(parent__isnull=True)


###################################################################################################
# start 购物车相关接口

from .mixins import BaykeCartPushMixin
class BaykeCartViewMixin:
    """ GenericAPIView 属性集合 """
    from .serializers import BaykeCartSerializer
...
class BaykeCartUpdateCountAPIView(BaykeCartViewMixin, RetrieveUpdateAPIView):
    ...
    """ 修改购物车商品数量 """
    from .serializers import BaykeCartUpdateCountSerializer
